...
include 'sidebar.php';
require_once 'other_forecasts.php'; 
...
// --- START OF SMA FORECAST AND CHART LOGIC ---
...
// --- VALIDATION AND FINAL FORECAST (SMA) ---
$smaPeriod = 12;
$forecastPeriods = 3; 
...
$smaValidationResult = simpleMovingAverage($trainingData, $smaPeriod, $forecastPeriods);
$sma_forecast_validation = $smaValidationResult['forecast'];
$sma_mae = calculateMAE($validationData, $sma_forecast_validation);

$smaFinalResult = simpleMovingAverage($actualSalesFiltered, $smaPeriod, $forecastPeriods);
$forecastDataSMA = array_map(function($value) {
    return max(0, round($value, 0));
}, $smaFinalResult['forecast']);
...
$forecastChartData = array_merge(array_fill(0, count($actualSales), null), $forecastDataSMA);
// --- END OF SMA FORECAST AND CHART LOGIC ---
?>
...
<head>
    ...
    <title>SMA Forecast - MarkeTrack</title>
...
<div class="main-content">
    <div class="card p-4 mb-4">
        <h2>Forecasting: Simple Moving Average (SMA)</h2>
        <p>This page analyzes sales data using the Simple Moving Average method.</p>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Model Accuracy (SMA)</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo number_format($sma_mae, 2); ?></td>
                        </tr>
                        </tbody>
                </table>
            </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">SMA Forecast vs Actual</h6>
        </div>
